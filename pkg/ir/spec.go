...
func (s *ConfigDefs) inverseLookupVPE(ip *netset.IPBlock) (result string, ok bool) {
...
func (s *ConfigDefs) SubnetNameFromIP(cidr *netset.IPBlock) (string, bool) {
...
func (s *ConfigDefs) VPEFromIP(ip *netset.IPBlock) (string, bool) {
...
func (s *ConfigDefs) RemoteFromIP(ip *netset.IPBlock) RemoteType {
