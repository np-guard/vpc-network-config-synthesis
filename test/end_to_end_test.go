...
func TestCSVCompare(t *testing.T) {
	suite := map[string]TestCase{
		...
		"acl_cidr_segment csv":        aclTestCase("acl_cidr_segment", "csv", false),
		"acl_cidr_segment tf":         aclTestCase("acl_cidr_segment", "tf", false),
		"acl_cidr_segment single csv": aclTestCase("acl_cidr_segment", "csv", true),
		"acl_cidr_segment single tf":  aclTestCase("acl_cidr_segment", "tf", true),
