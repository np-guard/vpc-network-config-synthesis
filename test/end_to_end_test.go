...
func TestCSVCompare(t *testing.T) {
	suite := map[string]TestCase{
		...
		"acl_tg_multiple2 tf":          aclTestCase("acl_tg_multiple", "tf", false, true),
		"acl_tg_multiple2 single tf":   aclTestCase("acl_tg_multiple", "tf", true, true),
		...
		"sg_tg_multiple2 csv":          sgTestCase("sg_tg_multiple", "csv", true),
		"sg_tg_multiple2 tf":           sgTestCase("sg_tg_multiple", "tf", true),
